 ...
 */
export declare const RUNTIME_CACHE_NAME = "wavelength-runtime-v1-v0.1.1";
/**
 ...
 */
export declare function absoluteRuntimeUrl(url: string): string;
/**
 ...
 */
export declare function openRuntimeCache(): Promise<Cache | undefined>;
/**
 * matchRuntimeAsset returns the cached response for a runtime asset, or
 * undefined when it has not been stored yet.
 */
export declare function matchRuntimeAsset(cache: Cache, url: string): Promise<Response | undefined>;
/**
 ...
 */
export declare function storeRuntimeAsset(cache: Cache, url: string, response: Response): Promise<boolean>;
/**
 ...
 */
export declare function pruneRuntimeCache(cache: Cache, keepUrl: string): Promise<number>;
/**
 ...
 */
export declare function evictRuntimeAsset(cache: Cache, url: string): Promise<void>;
