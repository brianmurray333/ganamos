...
const missingConfig = { autoStart: true };
// Valid combinations all compile.
const withAutoStart = {
    config: { network: 'regtest' },
    autoStart: true,
};
const configOnly = { config: { network: 'regtest' } };
const neither = {};
const autoStartFalseAlone = { autoStart: false };
void missingConfig;
void withAutoStart;
void configOnly;
void neither;
void autoStartFalseAlone;
const everyClientOptionIsForwarded = true;
