import { WavelengthClient, type DistributiveOmit, type PasskeyCeremony, type WavelengthPerformanceListener, type WalletEngine, type WalletEngineOptions } from '@lightninglabs/wavelength-core';
import { assertPasskeyPrf, createWebPasskeyCeremony, registerPasskeyWallet, supportsPasskeyPrf } from './passkey.ts';
/**
 ...
 */
export declare function createWebClient(options?: WebClientOptions): WavelengthClient;
/**
 ...
 * true.
 */
export type WebWalletEngineOptions = WebClientOptions & DistributiveOmit<WalletEngineOptions, 'client'>;
/**
 ...
 */
export declare function createWebWalletEngine(options?: WebWalletEngineOptions): WalletEngine;
 ...
 */
export declare const webPasskeyCeremony: PasskeyCeremony;
