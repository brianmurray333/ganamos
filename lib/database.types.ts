    ...
    Tables: {
      ...
      user_wallets: {
        Row: {
          id: string
          user_id: string
          wallet_type: "custodial" | "nwc"
          nwc_connection_encrypted: string | null
          nwc_relay_url: string | null
          nwc_pubkey: string | null
          permissions: string[]
          wallet_name: string
...
export type PendingSpend = Database["public"]["Tables"]["pending_spends"]["Row"]
export type FlappyBirdScore = Database["public"]["Tables"]["flappy_bird_game"]["Row"]
