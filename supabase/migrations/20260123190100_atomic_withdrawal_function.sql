-- Migration: Atomic withdrawal completion function
-- This migration adds:
-- Atomic withdrawal completion function with row-level locks
...
BEGIN
  ...
  IF v_updated_rows = 0 THEN
    -- RAISE EXCEPTION triggers automatic rollback, reverting transaction status change
