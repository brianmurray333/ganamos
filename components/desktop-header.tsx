          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="w-64 p-2">
              ...
              <DropdownMenuItem 
                ...
                className="py-2.5 px-3 rounded-lg flex items-center gap-3 transition-opacity"
              >
              ...
              <DropdownMenuItem 
                ...
                className="py-2.5 px-3 rounded-lg text-red-600 dark:text-red-400 flex items-center gap-3 transition-opacity"
              >
