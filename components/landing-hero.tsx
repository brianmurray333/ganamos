...
export function LandingHero() {
  ...
  return (
    <div className="flex flex-col items-center text-center">
      ...
      <p className="mt-2 text-lg text-muted-foreground font-medium bg-white/50 dark:bg-gray-900/50 px-3 py-1.5 rounded-full flex items-center justify-center gap-1">
