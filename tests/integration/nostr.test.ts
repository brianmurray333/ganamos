...
describe('lib/nostr.ts - Nostr Integration', () => {
  ...
  describe('postToNostr()', () => {
    ...
    describe('Error Handling', () => {
      it('should throw error when NOSTR_PRIVATE_KEY not configured', async () => {
        const originalKey = process.env.NOSTR_PRIVATE_KEY
        ...
        // Restore
        process.env.NOSTR_PRIVATE_KEY = originalKey
      })

      it('should handle error when NOSTR_PRIVATE_KEY is invalid format', async () => {
        const originalKey = process.env.NOSTR_PRIVATE_KEY
        process.env.NOSTR_PRIVATE_KEY = 'invalid-key'
  ...
  describe('Connection Pool Management', () => {
    it('should reuse singleton pool across multiple calls', async () => {
      await postToNostr({
        title: 'Test Issue 1',
    ...
    it('should close pool when closeNostrPool called', () => {
